...
namespace MatchMaking.API.Migrations
{
    ...
    [Migration("20200903142740_chanignMessage")]
    partial class chanignMessage
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MatchMaking.API.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MatchMaking.API.Models.Message", b =>
                {
                    b.HasOne("MatchMaking.API.Models.User", "Recipient")
                        .WithMany("MessagesReceived")
                        .HasForeignKey("RecipientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MatchMaking.API.Models.User", "Sender")
